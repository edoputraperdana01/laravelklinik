...
<div id="wrapper" class="d-flex w-100 overflow-hidden">
    ...
    <div id="content-wrapper" class="d-flex flex-column w-100 min-vh-100 bg-light position-relative">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow-sm px-4">
            ...
            <h5 class="d-none d-sm-block m-0 fw-bold text-secondary">Form Rekam Medis (Dokter)</h5>
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="card border-0 shadow-sm rounded-4 mb-5">
                            ...
                            <div class="card-header bg-white py-4 rounded-top-4 border-bottom">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 small text-muted">Isi data pemeriksaan klinis pasien.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-4 p-md-5">
                                {{-- ACTION KHUSUS DOKTER --}}
                                <form action="/tambah-rekam-medis-dokter" method="POST">
                                    @csrf
                                    
                                    {{-- BAGIAN 1: DATA PASIEN --}}
                                    <h6 class="text-uppercase fw-bold text-secondary mb-3 small border-bottom pb-2">Data Pasien & Waktu</h6>
                                    ...
                                    <div class="row g-4 mb-4">
                                        <div class="col-12">
                                            ...
                                            <input required class="form-control form-control-lg" type="text" name="nama_penyakit" value="{{ old('nama_penyakit') }}" placeholder="Contoh: Influenza, Hipertensi, dll">
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control" name="keterangan" rows="5" placeholder="Tuliskan resep, saran, atau catatan tambahan...">{{ old('keterangan') }}</textarea>
                                    </div>

                                    <div class="d-flex justify-content-between align-items-center mt-5">
                                        <a href="/lihat-rekam-medis" class="btn btn-light border px-4">
                                            <i class="fa-solid fa-arrow-left me-2"></i> Kembali
                                        </a>
                                        <button type="submit" class="btn btn-royal px-5 py-2 shadow fw-bold rounded-pill">
                                            <i class="fa-solid fa-stethoscope me-2"></i> Simpan Pemeriksaan
                                        </button>
                                    </div>
